---
lab:
  title: "Créer un copilote personnalisé avec un flux d’invite dans Azure\_AI\_Studio"
---

# Créer un copilote personnalisé avec un flux d’invite dans Azure AI Studio
